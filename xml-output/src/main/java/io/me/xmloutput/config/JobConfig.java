package io.me.xmloutput.config;

import io.me.xmloutput.domain.Customer;
import io.me.xmloutput.domain.CustomerRowMapper;
...
public class JobConfig {
    ...
    @Bean
    StaxEventItemWriter<Customer> customerItemWriter() throws Exception {
        ...
        System.out.println(">> Output Path: " + customerOutput);
    ...
    Step step() throws Exception {
        return stepBuilderFactory.get("step266")
